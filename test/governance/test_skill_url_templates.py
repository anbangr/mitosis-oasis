...
# Canonical API endpoints from oasis/governance/endpoints.py
API_ENDPOINTS = {
...
# ---------- Test 1: URL templates contain {session_id} ----------

def test_url_templates_contain_session_id():
    """Every tool URL template must include the {session_id} placeholder."""
    data = _load_skill()
